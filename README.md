...
Another important question to ask is can our multiple linear model accurately predict data using prediction intervals? We tested this idea by looking at a sample size where no one gets their fruits and vegetables in daily.
